	...
	if($_GET)
{
	$isira=$_GET["isira"];
		...
		$yazioku=al(bul("Select * from yazilar where isira='$isira'"));
	if (!$yazioku)
{
...
<head>
  <meta charset="UTF-8">
  <title><?php echo $yazioku["ibaslik"];?> - <?php echo SiteAdi;?></title>
...
<h2 class="title"><?php echo $yazioku["ibaslik"];?></h2>
<p>&nbsp;</p>
<p><?php echo $yazioku["icerik"];?></p>
<p>&nbsp;</p>
